...
All notable changes to Work Command Center are documented here. The format
...
- Claude reviewer bridge over `thread.json`; `wcc-review` + `wcc-worklog` skills.
...
- Optional `wcc` MCP controller for detached server lifecycle.

[Unreleased]: https://github.com/o1evo/WorkCommandCenter/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/o1evo/WorkCommandCenter/releases/tag/v0.1.0
